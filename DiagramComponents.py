...
class Component:
    ...
    def setPipes(self, pipe_top_fluid_state, pipe_right_fluid_state, pipe_buttom_fluid_state, fill_4):
    ...
    def setFill(self, pipe_top_fluid_state, pipe_right_fluid_state, pipe_buttom_fluid_state, fill_4):
